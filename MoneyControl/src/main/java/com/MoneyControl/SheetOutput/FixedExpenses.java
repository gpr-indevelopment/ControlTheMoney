...
public class FixedExpenses {
    ...
    private final String SHEET_NAME = "Fixed Expenses";
    public static final String FIXED_EXPENSES_KEY = "fixedExpenses";
    private static final String[] HEADERS = {"Date", "Description", "Debit"};

    public Workbook buildFixedExpensesSheet(Map<String, List> expensesMap, Workbook workbook){
        List<BankReport> bankReportList = expensesMap.get(FIXED_EXPENSES_KEY);
