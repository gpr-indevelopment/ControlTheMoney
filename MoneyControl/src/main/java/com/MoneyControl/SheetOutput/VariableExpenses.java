...
public class VariableExpenses {
    private final String SHEET_NAME = "Variable Expenses";
    public static final String VARIABLE_EXPENSES_KEY = "variableExpenses";
    private static final String[] HEADERS = {"Date", "Description", "Debit"};

    public Workbook buildVariableExpensesSheet(Map<String, List> expensesMap, Workbook workbook){
        List<BankReport> bankReportList = expensesMap.get(VARIABLE_EXPENSES_KEY);
